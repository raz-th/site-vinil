    ...
    return (
        <aside>
            ...
            <div className="leftSection_content">
                <ol>
                    <li className={path === "/user/myaccount" ? 'selected' : ''} onClick={() => router.push("/user/myaccount")}><FaRegUser /> Contul meu</li>
                    <li className={path === "/user/myaccount/comenzile-mele" ? 'selected' : ''} onClick={() => router.push("/user/myaccount/comenzile-mele")}><SlHandbag /> Comenzile mele</li>
